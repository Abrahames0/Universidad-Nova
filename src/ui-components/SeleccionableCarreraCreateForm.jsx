...
export default function SeleccionableCarreraCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new SeleccionableCarrera(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "SeleccionableCarreraCreateForm")}
      {...rest}
    >
      <TextField
        label="Carrera"

...
export default function SeleccioCarreraCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new SeleccioCarrera(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "SeleccioCarreraCreateForm")}
      {...rest}
    >
      <TextField
        label="Carrera"

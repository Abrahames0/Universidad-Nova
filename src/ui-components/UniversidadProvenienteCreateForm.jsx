...
export default function UniversidadProvenienteCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setUniversidadProveniente(initialValues.universidadProveniente);
    setErrors({});
  };
  const validations = {
    universidadProveniente: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new UniversidadProveniente(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "UniversidadProvenienteCreateForm")}
      {...rest}
    >
      <TextField

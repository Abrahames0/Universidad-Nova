...
export default function SeleccionableUpdateForm(props) {
  const {
    id: idProp,
    seleccionable: seleccionableModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = seleccionableRecord
      ? { ...initialValues, ...seleccionableRecord }
      : initialValues;
  ...
  const [seleccionableRecord, setSeleccionableRecord] = React.useState(
    seleccionableModelProp
  );
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Seleccionable, idProp)
        : seleccionableModelProp;
      setSeleccionableRecord(record);
    };
    queryData();
  }, [idProp, seleccionableModelProp]);
  React.useEffect(resetStateValues, [seleccionableRecord]);
  const validations = {
    nombreBachillerato: [],
    ciudad: [],
    especialidad: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Seleccionable.copyOf(seleccionableRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "SeleccionableUpdateForm")}
      {...rest}
    >
      <TextField
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || seleccionableModelProp)}

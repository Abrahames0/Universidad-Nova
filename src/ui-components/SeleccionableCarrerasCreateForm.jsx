...
export default function SeleccionableCarrerasCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setCarreras(initialValues.carreras);
    setErrors({});
  };
  const validations = {
    carreras: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new SeleccionableCarreras(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "SeleccionableCarrerasCreateForm")}
      {...rest}
    >
      <TextField
        label="Carreras"

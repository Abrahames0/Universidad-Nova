...
export default function SeleccionableEspecialidadCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new SeleccionableEspecialidad(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "SeleccionableEspecialidadCreateForm")}
      {...rest}
    >
      <TextField
        label="Especialidad"

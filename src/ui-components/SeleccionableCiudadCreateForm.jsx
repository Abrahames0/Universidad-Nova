...
export default function SeleccionableCiudadCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new SeleccionableCiudad(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "SeleccionableCiudadCreateForm")}
      {...rest}
    >
      <TextField
        label="Ciudad"

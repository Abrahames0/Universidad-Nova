...
export default function SeleccionableBachilleratoCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new SeleccionableBachillerato(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "SeleccionableBachilleratoCreateForm")}
      {...rest}
    >
      <TextField
